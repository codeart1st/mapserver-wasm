...
describe('WFS 2.0.0', () => {
  const globalParams = 'SERVICE=WFS&VERSION=2.0.0'
  ...
  test('GetFeature request with Intersects Filter should return a valid feature', () => {
    ...
    const body = `<?xml version="1.0" encoding="UTF-8"?>
      <wfs:GetFeature xmlns:wfs="http://www.opengis.net/wfs" maxFeatures="10" outputFormat="text/xml; subtype=gml/3.2.1" resultType="results" service="WFS" version="2.0.0">
